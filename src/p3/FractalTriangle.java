      ...
      public FractalTriangle( int depth, ATriangle tri, int height ) {
         ...
         if( depth > 1 && height > minHeight )
         {
            if ( depth <= maxDepth )
            {
               ...
               arrayFT[0] = new FractalTriangle(this.makeTriangle(points[0], points[1]),
                       this, depth - 1, this.makeTriangle(points[0], points[1]).getHeight());
               arrayFT[1] = new FractalTriangle(this.makeTriangle(points[1], points[2]),
                       this, depth - 1, this.makeTriangle(points[0], points[1]).getHeight());
               arrayFT[2] = new FractalTriangle(this.makeTriangle(points[2], points[0]),
                       this, depth - 1, this.makeTriangle(points[0], points[1]).getHeight());
            }
         }
