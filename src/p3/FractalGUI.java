...
public class FractalGUI extends JPanel 
{
    ...
    private static int defaultVal = 50;
    //--------------- instance variables ----------------------------   
    ...
    private void reset()
    {
        ...
        ///////////////////////////////////////////////////////
        _sizeSlider.setValue( defaultVal );
        _projectionSlider.setValue( defaultVal );
        _heightSlider.setValue( defaultHeight );
        _offsetSlider.setValue( defaultVal );
    ...
    private void makeScene()
    {
        ...
        {
            Point p2 = top.getPointOnNormalAt( 
                                             FractalTriangle.p2projection, h );
    ...
    public class SizeListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            ...
            //_sizeSlider.
            _sizeSlider = (JSlider) ev.getSource();
            Number sizeVal = (Number) _sizeSlider.getValue();
            int value = sizeVal.intValue();
            if( value >= 5 )
            {
                double val2 = value / 100.0;
                
                FractalTriangle.sizeRatio = val2;
                makeScene();
    ...
    public class OffsetListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            ...
            ///////////////////////////////////////////////////////
            _offsetSlider = (JSlider) ev.getSource();
            Number sizeVal = (Number) _offsetSlider.getValue();
            int value = sizeVal.intValue();
            double val2 = value / 100.0;
            
            FractalTriangle.offset = val2;
            makeScene();
    ...
    public class ProjectionListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            ...
            ///////////////////////////////////////////////////////
            _projectionSlider = (JSlider) ev.getSource();
            Number sizeVal = (Number) _projectionSlider.getValue();
            int value = sizeVal.intValue();
            double val2 = value / 100.0;
            
            FractalTriangle.p2projection = val2;
            makeScene();
        }
    }
    ...
    public class InitialHeightListener implements ChangeListener
    {
        ...
        public void stateChanged( ChangeEvent ev )
        {
            ...
            ///////////////////////////////////////////////////////
            _heightSlider = (JSlider) ev.getSource();
            Number sizeVal = (Number) _heightSlider.getValue();
            int value = sizeVal.intValue();
            height = value;
            makeScene();
        }
