...
public class RadioSliderGUI extends JPanel
{
    ...
    private void buildSliders( Container parent )
    {
        ...
        SliderListener sListen = new SliderListener( szSlider, "sz" );
        szSlider.addChangeListener( sListen );
