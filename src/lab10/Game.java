...
public class Game
{
    ...
    {      
        ...
        _discards.setXOffset( 5 );
        _drawPile.setXOffset( 3 );
    ...
    public void shuffle()
    {
        ...
        for( int i = 0; i < 50; i++ )
        {
            int first = r1.nextInt( 52 );
            int second = r1.nextInt( 52 );
            Card c1 = _baseDeck.get( first );
            Card c2 = _baseDeck.get( second );
            _baseDeck.set( first, c2 );
            _baseDeck.set( second, c1 );
