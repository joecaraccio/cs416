...
public class JPlayer extends JComponent implements Animated, MouseListener, MouseMotionListener
{
    ...
    public void mouseDragged( MouseEvent me )
    {
        ...
        ////////////////////////////////////////////////////////////////
         Point _newMouse = getParent().getMousePosition();
         int dX = _newMouse.x - _saveMouse.x;
         int dY =  _newMouse.y - _saveMouse.y;

         if( _saveMouse.x + dX > maxX() || _saveMouse.y + dY > maxY())
         {
             
         } else {
                      moveBy( dX, dY);
                      _saveMouse = getLocation();
         }
